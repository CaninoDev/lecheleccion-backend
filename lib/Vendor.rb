# Third party module for initialiasing connections and interfacing with their assets
module Vendor
  attr_accessor :google_news_api, :aylien_news_api, :aylien_text_api, :iptc_subject_codes

  def self.included
   select_iptc_subjectcodes
   init_aylien_text
   init_aylien_news
   init_indico
  ...
  def self.select_iptc_subjectcodes
   @iptc_subject_codes = %w[
     11000000 16000000 14000000 02000000 04000000 05000000 06000000
     06004000 07011000 07013000 11024000 11024001 11005001 06004000
     11006001 11006012 16003003 11002002 11009000 09004000 11023000
     04008005 11003000 16003002]
  end
